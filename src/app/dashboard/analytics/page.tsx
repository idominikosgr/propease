  ...
  const calculateTrend = (data: AnalyticsData) => {
    ...
    return {
      properties: {
        ...
        trend:
          previousTotal > 0
            ? ((data.metrics.properties.newInPeriod - previousTotal) / previousTotal) * 100
            : 0,
      },
      inquiries: {
        current: data.metrics.inquiries.inPeriod,
        trend:
          data.metrics.inquiries.total > data.metrics.inquiries.inPeriod
            ? ((data.metrics.inquiries.inPeriod -
                (data.metrics.inquiries.total - data.metrics.inquiries.inPeriod)) /
                (data.metrics.inquiries.total - data.metrics.inquiries.inPeriod)) *
              100
            : 0,
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {analytics.metrics.properties.total.toLocaleString()}
                    </p>
                    <p className="text-xs text-green-600 flex items-center gap-1">
                      <TrendingUp className="h-3 w-3" />+{analytics.metrics.properties.newInPeriod}{' '}
                      this period
                    </p>
                  </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {analytics.metrics.inquiries.total.toLocaleString()}
                    </p>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold">
                      {analytics.metrics.sync.total.toLocaleString()}
                    </p>
                    <p className="text-xs text-green-600 flex items-center gap-1">
                      <CheckCircle2 className="h-3 w-3" />
                      {getSuccessRate(
                        analytics.metrics.sync.successful,
                        analytics.metrics.sync.total
                      )}
                      % success rate
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Range: {formatPrice(analytics.metrics.properties.priceRange.min)} -{' '}
                      {formatPrice(analytics.metrics.properties.priceRange.max)}
                    </p>
                  </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="font-semibold">
                      {analytics.metrics.properties.newInPeriod}
                    </span>
                  </div>
                  <Progress
                    value={Math.min(
                      (analytics.metrics.properties.newInPeriod /
                        analytics.metrics.properties.total) *
                        100,
                      100
                    )}
                    className="h-2"
                ...
                <div>
                  ...
                  <Progress
                    value={Math.min(
                      (analytics.metrics.inquiries.inPeriod / analytics.metrics.inquiries.total) *
                        100,
                      100
                    )}
                    className="h-2"
                ...
                <div>
                  ...
                  <Progress
                    value={Math.min(
                      (analytics.metrics.sync.inPeriod / analytics.metrics.sync.total) * 100,
                      100
                    )}
                    className="h-2"
                  />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-semibold">
                      {analytics.metrics.properties.byStatus.active}
                    </span>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={
                      analytics.metrics.sync.lastSyncStatus === 'completed'
                        ? 'default'
                        : 'destructive'
                    }
                    className={
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-green-600">
                    {analytics.metrics.inquiries.conversionRate}%
                  </span>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-green-600">
                    +{analytics.metrics.sync.totalPropertiesAdded}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">Updated from Sync</span>
                  <span className="font-semibold text-blue-600">
                    ~{analytics.metrics.sync.totalPropertiesUpdated}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm">Avg Inquiry Value</span>
                  <span className="font-semibold">
                    {formatPrice(analytics.metrics.inquiries.averagePropertyPrice)}
                  </span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="font-semibold">
                        {analytics.metrics.properties.byStatus.inactive}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        {Math.round(
                          (analytics.metrics.properties.byStatus.inactive /
                      ...
                      <div key={area} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Progress
                            value={
                              (count /
                                Math.max(...Object.values(analytics.metrics.properties.byArea))) *
                              100
                            }
                            className="w-20 h-2"
                          />
              ...
              <CardContent>
                <div className="text-center">
                  <div className="text-4xl font-bold text-green-600">
                    {getSuccessRate(
                      analytics.metrics.sync.successful,
                      analytics.metrics.sync.inPeriod
                    )}
                    %
                  </div>
                  <p className="text-muted-foreground">
                    {analytics.metrics.sync.successful} of {analytics.metrics.sync.inPeriod}{' '}
                    successful
                  </p>
                </div>
              </CardContent>
                ...
                <div className="text-center">
                  ...
                  <div className="mt-2 text-sm text-muted-foreground space-y-1">
                    <div className="text-green-600">
                      +{analytics.metrics.sync.totalPropertiesAdded} added
                    </div>
                    <div className="text-blue-600">
                      ~{analytics.metrics.sync.totalPropertiesUpdated} updated
                    </div>
                  </div>
                </div>
              </CardContent>
                  ...
                  >
                    <div>
                      ...
                      <div className="text-sm mt-1">
                        {session.total_properties || 0} properties • +{session.new_properties || 0}{' '}
                        new • ~{session.updated_properties || 0} updated
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold">
                      {analytics.metrics.inquiries.byStatus.contacted}
                    </p>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold">
                      {analytics.metrics.inquiries.byStatus.converted}
                    </p>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold">
                      {analytics.metrics.inquiries.byStatus.closed}
                    </p>
                      ...
                      <div key={source} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Progress
                            value={
                              (count /
                                Math.max(...Object.values(analytics.metrics.inquiries.bySource))) *
                              100
                            }
                            className="w-20 h-2"
                          />
                      ...
                      <div key={area} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Progress
                            value={
                              (count /
                                Math.max(...Object.values(analytics.metrics.inquiries.topAreas))) *
                              100
                            }
                            className="w-20 h-2"
                          />
        ...
        <TabsContent value="trends" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Activity over the last {period} days</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                        ...
                        <div className="flex flex-col items-center gap-1 h-full justify-end">
                          {day.properties > 0 && (
                            <div
                              ...
                              style={{
                                height: `${Math.max(2, (day.properties / Math.max(...analytics.charts.daily.map((d) => d.properties))) * 40)}px`,
                                width: '8px',
                              }}
                          ...
                          {day.inquiries > 0 && (
                            <div
                              ...
                              style={{
                                height: `${Math.max(2, (day.inquiries / Math.max(...analytics.charts.daily.map((d) => d.inquiries))) * 40)}px`,
                                width: '8px',
                              }}
                          ...
                          {day.conversions > 0 && (
                            <div
                              ...
                              style={{
                                height: `${Math.max(2, (day.conversions / Math.max(...analytics.charts.daily.map((d) => d.conversions))) * 20)}px`,
                                width: '8px',
                              }}
                          ...
                          {day.syncSessions > 0 && (
                            <div
                              ...
                              style={{
                                height: `${Math.max(2, (day.syncSessions / Math.max(...analytics.charts.daily.map((d) => d.syncSessions))) * 30)}px`,
                                width: '8px',
                              }}
